    ...
    <header className="fixed top-0 left-0 right-0 h-16 z-40 bg-[#FDF9F1]/95 backdrop-blur-md border-b border-[#ECE8E0]/80 shadow-[0_1px_8px_rgba(180,83,9,0.03)]">
      <div className="h-16 w-full px-3 sm:px-6 lg:px-8 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2.5 sm:gap-4 min-w-0">
          ...
          <span
            className="text-base sm:text-2xl tracking-tight text-[#903F00] font-normal truncate"
          ...
          <span className="hidden xl:inline-block w-1.5 h-1.5 rounded-full bg-[#DDC1B3]" />

          <span className="hidden xl:inline-block text-xs text-[#8C827A] font-mono tracking-widest uppercase">
            {currentDate} • {currentTime}
          </span>
        </div>

        {/* Right: Touch-Optimized Actions */}
        <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
          ...
          >
            ...
            <span className="hidden md:inline text-[11px] font-semibold uppercase tracking-wider text-[#54524F]">
