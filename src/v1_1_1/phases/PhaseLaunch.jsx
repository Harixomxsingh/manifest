  ...
  return (
    <div className="w-full max-w-[42rem] mx-auto flex flex-col items-center py-4 sm:py-8 animate-fadeIn">
      ...
      <div className="w-full flex flex-col items-center text-center gap-6">
        {/* Launch Emblem */}
        <div className="relative w-20 h-20 flex items-center justify-center rounded-full bg-[#FEF3C7] border border-[#FDE68A] text-[#B45309] shadow-sm">
          <Compass className="w-10 h-10 text-[#D97706] stroke-[1.8]" />
        </div>
        ...
        <div>
          ...
          <h1
            className="text-3xl sm:text-4xl text-[#1C1C17] tracking-tight font-normal leading-tight"
            style={{ fontFamily: '"Playfair Display", "Bodoni Moda", Georgia, serif' }}
          >
            Go Forth With Unshakeable Focus
          </h1>
          <p className="text-xs sm:text-sm text-[#54524F] mt-2 max-w-lg mx-auto">
        ...
        <div className="w-full rounded-2xl bg-white p-6 sm:p-7 border border-[#EDE5D8] shadow-xs text-left flex flex-col gap-4">
          <div className="p-4 rounded-xl bg-[#FEF3C7]/80 border border-[#FDE68A] flex items-start gap-3">
            ...
            <div>
              ...
              <div className="text-sm font-semibold text-[#1C1C17] italic">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="p-3.5 rounded-xl bg-[#F7F3EB] border border-[#ECE8E0]">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto pt-2">
          <button
            ...
            className={`w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full text-xs font-semibold border transition-all ${
              isAudioPlaying
          ...
          <button
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-[#F7F3EB] hover:bg-[#ECE8E0] text-[#54524F] border border-[#ECE8E0] text-xs font-mono transition-all"
          >
