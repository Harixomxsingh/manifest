...
export default function PhaseIdentity({ onAdvance }) {
  ...
  return (
    <div className="w-full max-w-[42rem] mx-auto flex flex-col items-center py-2 sm:py-10 animate-fadeIn">
      {/* Top Progress Indicator */}
      <div className="w-full mb-6 sm:mb-8 flex flex-col gap-2">
      ...
      {/* Centered Visual Anchor Emblem */}
      <div className="mb-4 sm:mb-6 flex justify-center">
        <div className="relative w-16 h-16 sm:w-18 sm:h-18 flex items-center justify-center p-3 rounded-full bg-[#FEF3C7]/40 border border-[#FDE68A]/60 shadow-[0_0_24px_rgba(217,119,6,0.12)]">
          <svg className="w-12 h-12 sm:w-14 sm:h-14 text-[#D97706] animate-[spin_60s_linear_infinite]" fill="none" stroke="currentColor" viewBox="0 0 100 100">
      ...
      <div className="mb-2 sm:mb-3">
        <span className="inline-flex items-center px-3.5 py-1 rounded-full bg-[#FEF3C7] border border-[#FDE68A]/70 text-[#B45309] text-[10px] sm:text-[11px] font-semibold font-mono uppercase tracking-wider sm:tracking-widest shadow-xs">
      ...
      {/* Section Header */}
      <h1
        className="text-2xl sm:text-4xl text-[#1C1C17] text-center tracking-tight mb-6 sm:mb-8 font-normal px-2"
      ...
      {/* Tactile Body Card */}
      <div className="w-full bg-white rounded-2xl p-4 sm:p-8 border border-[#ECE4D6] shadow-[0_4px_24px_rgba(180,83,9,0.04)] flex flex-col gap-5 sm:gap-6 relative overflow-hidden">
        <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-[#D97706]/60 to-transparent" />

        {/* Reflection Paragraph */}
        <p className="text-sm sm:text-base text-[#54524F] leading-relaxed text-left">
          {anchor.content}
        </p>

        {/* Contextual Illustration Anchor Strip */}
        <div className="relative w-full h-36 sm:h-44 rounded-xl overflow-hidden bg-[#F7F3EB] flex items-center justify-center border border-[#ECE8E0]">
          <img
          ...
          <div className="absolute bottom-2.5 sm:bottom-3 left-3 sm:left-4 flex items-center gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-[#D97706]" />
            <span className="text-[9px] sm:text-[10px] font-mono text-white/90 uppercase tracking-widest font-semibold">
        ...
        <div className="relative p-4 sm:p-5 rounded-xl bg-gradient-to-br from-[#FEF3C7]/80 to-[#FDF1DB] border border-[#FDE68A]/80 text-[#B45309] flex flex-col gap-2 shadow-[0_2px_12px_rgba(217,119,6,0.06)]">
          <div className="flex items-center gap-2 text-[#D97706]">
            <span className="material-symbols-outlined text-[18px]">verified</span>
            <span className="text-[10px] sm:text-[11px] font-mono uppercase tracking-widest font-bold text-[#B45309]">
              Core Affirmation
            </span>
          </div>
          <blockquote
            className="text-base sm:text-xl text-[#903F00] italic leading-snug font-normal"
            style={{ fontFamily: '"Playfair Display", "Bodoni Moda", Georgia, serif' }}
          >
        ...
        <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 border-t border-[#ECE8E0]/70">
          <button
            type="button"
            onClick={handleToggleAffirm}
            className="flex items-center gap-3 cursor-pointer select-none group text-left p-2 sm:p-0 rounded-xl hover:bg-[#F7F3EB] sm:hover:bg-transparent transition-colors touch-manipulation"
          >
            <div
          ...
          <span className="text-[11px] sm:text-xs font-mono text-[#8C827A] text-right sm:text-left pr-2 sm:pr-0">
