...
export default function PhaseWelcome({ onAdvance }) {
  ...
  return (
    <div className="w-full max-w-[42rem] mx-auto flex flex-col items-center py-4 sm:py-8 animate-fadeIn relative">
      {/* Radiant Sunlight Flare / Diffusion into the entire page */}
      <div className="absolute top-12 left-1/2 -translate-x-1/2 w-[600px] h-[350px] bg-gradient-to-b from-amber-400/25 via-amber-300/10 to-transparent blur-3xl pointer-events-none -z-10" />

      {/* Prominent Large Date & Time Pill Capsule (First Attention Anchor) */}
      <div className="mb-8 inline-flex items-center gap-3 px-6 sm:px-7 py-3 rounded-full bg-white/95 border border-[#ECE8E0] shadow-[0_4px_20px_rgba(180,83,9,0.07)] backdrop-blur-md transition-transform hover:scale-[1.01]">
        <span className="w-3 h-3 rounded-full bg-[#E0A96D] shadow-[0_0_8px_rgba(224,169,109,0.8)] shrink-0" />
        <span className="text-sm sm:text-base font-mono font-bold tracking-widest uppercase text-[#54524F]">
      ...
      <div className="mb-6 flex flex-col items-center justify-center relative">
        ...
        <div className="absolute w-44 h-44 rounded-full bg-amber-400/20 blur-2xl pointer-events-none" />
        ...
        {/* Realistic Ground Ellipse Shadow Beneath Sun */}
        <div className="w-16 h-1.5 rounded-full bg-gradient-to-r from-transparent via-[#D97706]/45 to-transparent blur-[1.5px] mt-3" />
      </div>

      {/* Badge Tag */}
      <div className="mb-3">
        <span className="inline-flex items-center px-3.5 py-1 rounded-full bg-[#FEF3C7] border border-[#FDE68A]/80 text-[#B45309] text-[11px] font-semibold font-mono uppercase tracking-widest shadow-xs">
      ...
      {/* Section Title */}
      <h1
        className="text-3xl sm:text-4xl text-[#1C1C17] text-center tracking-tight mb-7 font-normal"
      ...
      <div className="w-full bg-white rounded-2xl p-6 sm:p-8 border border-[#ECE4D6] shadow-[0_4px_24px_rgba(180,83,9,0.04)] flex flex-col gap-6 relative overflow-hidden">
        ...
        {/* Inspiring, concise intro copy */}
        <p className="text-base text-[#54524F] leading-relaxed text-center sm:text-left font-normal">
          Two minutes of deliberate clarity to silence the noise, ignite your momentum, and conquer what matters most.
        </p>

        {/* 3-Pill Preview Grid with proper truncation and zero overflow */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-1">
          {/* 1. Identity Anchor */}
          <div className="p-3.5 rounded-xl bg-[#F7F3EB] border border-[#ECE8E0] flex items-center gap-3 overflow-hidden">
